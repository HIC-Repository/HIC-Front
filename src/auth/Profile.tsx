                ...
                <form className="pt-4 mt-6 border-t border-gray-400">
                  <div className='flex flex-wrap -mx-3 mb-6'>
                    <div className='px-3 mb-6 w-full md:w-full'>
                      <label className='block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase' htmlFor='grid-text-1'>email address</label>
                      <Input className='block px-4 py-3 w-full leading-tight text-gray-700 bg-white rounded-md border border-gray-400 shadow-inner appearance-none focus:outline-none focus:border-gray-500' id='grid-text-1' type='text' placeholder='Enter email' required />
                    </div>
                    <div className='px-3 mb-6 w-full md:w-full'>
                    ...
                    <div className="pt-4 w-full border-t border-gray-400 personal">
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <div className='px-3 mb-6 w-full md:w-1/2'>
                          ...
                          <Input className='block px-4 py-3 w-full leading-tight text-gray-700 bg-white rounded-md border border-gray-400 shadow-inner appearance-none focus:outline-none focus:border-gray-500' type='text' required />
                        </div>
                        <div className='px-3 mb-6 w-full md:w-1/2'>
